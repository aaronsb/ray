...
- [ ] Implement surface point sampling for CSG primitives:
  - [ ] Box: uniform sampling on 6 faces
  - [ ] Sphere: uniform hemisphere/sphere sampling
  - [ ] Cylinder: sampling on curved surface + caps
- [ ] Calculate PDFs for each primitive type
- [ ] Sample random point on emissive surface

### Phase 3: Direct Lighting Integration
- [ ] For diffuse surfaces, sample emissive objects
- [ ] Cast shadow ray toward sampled point
- [ ] Weight by geometry term and PDF
- [ ] Combine with sun contribution
